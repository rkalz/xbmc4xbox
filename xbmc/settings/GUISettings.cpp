...
void CGUISettings::Initialize()
{
  ...
  AddDefaultAddon(5, "weather.script", 24027, DEFAULT_WEATHER_ADDON, ADDON_SCRIPT_WEATHER);
  AddString(6, "weather.scriptsettings", 21417, "", BUTTON_CONTROL_STANDARD, true);
  ...
  AddDefaultAddon(5, "musiclibrary.albumsscraper", 20193, "metadata.allmusic.com", ADDON_SCRAPER_ALBUMS);
  AddDefaultAddon(6, "musiclibrary.artistsscraper", 20194, "metadata.allmusic.com", ADDON_SCRAPER_ARTISTS);
  ...
  AddDefaultAddon(8, "musicplayer.visualisation", 250, DEFAULT_VISUALISATION, ADDON_VIZ);
  ...
  AddDefaultAddon(1, "scrapers.moviesdefault", 21413, "metadata.themoviedb.org", ADDON_SCRAPER_MOVIES);
  AddDefaultAddon(2, "scrapers.tvshowsdefault", 21414, "metadata.tvdb.com", ADDON_SCRAPER_TVSHOWS);
  AddDefaultAddon(3, "scrapers.musicvideosdefault", 21415, "metadata.mtv.com", ADDON_SCRAPER_MUSICVIDEOS);
  ...
  AddDefaultAddon(2, "screensaver.mode", 356, "screensaver.xbmc.builtin.dim", ADDON_SCREENSAVER);
  AddString(3, "screensaver.settings", 21417, "", BUTTON_CONTROL_STANDARD);
  AddString(4, "screensaver.preview", 1000, "", BUTTON_CONTROL_STANDARD);
  AddSeparator(5, "screensaver.sep1");
  AddBool(6, "screensaver.usemusicvisinstead", 13392, true);
  AddBool(7, "screensaver.usedimonpause", 22014, true);
