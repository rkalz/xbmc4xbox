...
bool CGUIPassword::SetMasterLockMode(bool bDetails)
{
  ...
  if (pDialog)
  {
    ...
    if (profile && pDialog->ShowAndGetLock(profile->_iLockMode,profile->_strLockCode,profile->_bLockMusic,profile->_bLockVideo,profile->_bLockPictures,profile->_bLockPrograms,profile->_bLockFiles,profile->_bLockSettings,12360,true,bDetails))
      return true;
