...
int curl_mprintf(const char *format, ...)
{
  ...
  retcode = dprintf_formatf(stdout, addbyter, format, ap_save);
  va_end(ap_save);
  return retcode;
}
...
int curl_mfprintf(FILE *whereto, const char *format, ...)
{
  ...
  va_list ap_save; /* argument pointer */
  va_start(ap_save, format);
  retcode = dprintf_formatf(whereto, addbyter, format, ap_save);
  va_end(ap_save);
  return retcode;
}
...
{
  return dprintf_formatf(stdout, addbyter, format, ap_save);
}

int curl_mvfprintf(FILE *whereto, const char *format, va_list ap_save)
{
  return dprintf_formatf(whereto, addbyter, format, ap_save);
}
