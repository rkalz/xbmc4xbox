...
IF NOT EXIST "%ProgramFiles%\Microsoft Visual Studio .NET 2003\Vc7\bin\vcvars32.bat" GOTO Vc9_Check
CALL "%ProgramFiles%\Microsoft Visual Studio .NET 2003\Vc7\bin\vcvars32.bat"
GOTO VC_DONE

:Vc9_Check
IF NOT EXIST "%ProgramFiles%\Microsoft Visual Studio 9.0\VC\bin\vcvars32.bat" GOTO NO_VC
